...
import { minifiedHTML } from '../../utils/minify'

const MinifyHTMLContainer: FC = () => {
	const timeoutRef = useRef<number>(-1)
	const [value, setValue] = useState<any>('')
	const [minify, setMinify] = useState<any>('<minifyHTML>minifyHTML</minifyHTML>')
...
export default MinifyHTMLContainer
